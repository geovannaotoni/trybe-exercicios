...
// 1- quantidade total da população de todos os países
...
// }
const longestName = () => {
  return countries.reduce((prev, curr) => prev.name.length > curr.name.length ? prev : curr);
};
console.log(longestName());

// 4 - quantidade de vezes que a letra a maiúscula ou minúscula aparece no array de nomes.
const names = [
