...
const conditionOneLineA = (lineA, lineB, lineC) => (lineA < lineB + lineC) && (lineA > Math.abs(lineB - lineC));
const conditionOneLineB = (lineA, lineB, lineC) => (lineB < lineA + lineC) && (lineB > Math.abs(lineA - lineC));
const conditionOneLineC = (lineA, lineB, lineC) => (lineC < lineA + lineB) && (lineC > Math.abs(lineA - lineB));

const conditionOne = (lineA, lineB, lineC) => {
  const checkLineA = conditionOneLineA(lineA, lineB, lineC);
  const checkLineB = conditionOneLineB(lineA, lineB, lineC);
  const checkLineC = conditionOneLineC(lineA, lineB, lineC);
