...
// esta sintaxe permite acessar o valor retornado via person.getWeight() - método público
  getWeight() {
    return this._weight;
  }

// esta sintaxe permite acessar o valor retornado via person.age (como se fosse um atributo normal) - método get
  get age() {
    return this._age;
  }

// do mesmo modo, esta sintaxe permite modificar o valor com uma simples atribuição: person.age = 42 mesmo que esteja ocorrendo uma validação internamente
